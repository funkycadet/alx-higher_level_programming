# Almost a circle
Project done during **Full Stack Software Engineering studies** at **ALX**. It aims to learn about unittesting, serialization, deserialization, JSON, `args` and `kwargs` in **Python**.
...
| `square.py` | Class that inherits attributes references from `Rectangle` class |
