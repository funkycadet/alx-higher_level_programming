...
class Base:
    ...
    def from_json_string(json_string):
        ...
        Staticmethod to turn JSON string to dictionary
    ...
    def create(cls, **dictionary):
        ...
        Classmethod that creates an instance
    ...
    def save_to_file_csv(cls, list_objs):
        ...
        Classmethod that saves object instance to CSV file
    ...
    def load_from_file_csv(cls):
        ...
        Classmethod that loads (serialize and deserialize) a CSV file
