...
This module defines a square based on 6-square.py by:
- Private instance attribute: size where:
    - property def size(self): to retrieve it
    - property setter def size(self, value): to set it where:
...
- Private instance attribute: position:
    ...
    - property setter def position(self, value): to set it where:
...
- prints a Square instance with same behaviour as my_print()
...
class Square:
    ...
    def __str__(self):
        ...
        This method is used to print an instance of Square
